...
public class ExpleoInsurance {
	...
	//initiate a browser
		...
		public void user_provides_the_details_of_new_user() {
			driver.findElement(By.xpath("//input[@id='firstName']")).sendKeys("Gowri");
			driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Sri");
			driver.findElement(By.xpath("//input[@id='email']")).sendKeys("gowrisri@gmail.com");
			...
			driver.findElement(By.xpath("//input[@id='startDate']")).sendKeys("04112024");
			driver.findElement(By.xpath("//input[@id='endDate']")).sendKeys("31122024");
			driver.findElement(By.xpath("//input[@id='address']")).sendKeys("xyz street, AAAA");
			driver.findElement(By.xpath("//input[@id='phoneNumber']")).sendKeys("9876543212");
		...
		public void user_is_applying_for_a_new_insurance() {
			...
			driver.findElement(By.xpath("//input[@id='Name']")).sendKeys("Dhanusya");
			driver.findElement(By.xpath("//input[@id='email']")).sendKeys("dhanusya@gmail.com");
			driver.findElement(By.xpath("//input[@id='Address']")).sendKeys("abc street, ZZZZ");
			driver.findElement(By.xpath("//input[@id='DateOfBirth']")).sendKeys("04112000");
		...
		public void user_changes_the_password() {
			...
			driver.findElement(By.xpath("//input[@placeholder=\"Confirm your new password\"]")).sendKeys("abc street, ZZZZ");
